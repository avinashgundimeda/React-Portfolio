    ...
    <div className="min-h-screen bg-[#fafafa] flex justify-center">
      <div className="w-full max-w-6xl bg-white px-8 py-24">
        ...
        <p className="text-gray-600 max-w-2xl leading-relaxed mb-12">
          Whether you have a question, a collaboration idea, or just want to say hi — my inbox is always open. 
          I enjoy connecting with developers, content creators, and teams working on meaningful products.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-16">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-700">avinashgundimeda@gmail.com</p>
          </div>
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-700">Open for freelance work & collaborations</p>
          </div>
