...
import "./carousel.css";
import database from "../assets/skillsLogos/sql.png";
import blender from "../assets/skillsLogos/blender.png";
import unity from "../assets/skillsLogos/unity.png";
import unreal from "../assets/skillsLogos/unrealengine.png";
import css from "../assets/skillsLogos/css.png";
...
import vscode from "../assets/skillsLogos/vscode.png";
import tailwind from "../assets/skillsLogos/tailwind.png";
import linux from "../assets/skillsLogos/linux.png";
import git from "../assets/skillsLogos/git.png";
import java from "../assets/skillsLogos/java.png";
import github from "../assets/skillsLogos/github.png";
          ...
          <div className="w-full max-w-6xl px-8 py-24 bg-white">
            <div className="max-w-3xl">
              ...
              <p className="text-gray-700 leading-relaxed mb-8">
                ...
                and hands-on projects. I enjoy exploring new tools,
                experimenting with ideas, and working on things that challenge
                me to grow.
              </p>
            </div>
            ...
            <div className="mt-20">
              ...
              <div className="overflow-hidden w-full">
                <div className="flex items-center gap-24 animate-skill-carousel whitespace-nowrap w-max">
                  ...
                  <div className="flex flex-col items-center group">
                    ...
                    <span className="text-xs font-medium text-gray-600 mt-2 group-hover:text-cyan-600 transition-colors duration-300">
                      Tailwind
                    </span>
                  </div>
                  ...
                  <div className="flex flex-col items-center group">
                    ...
                    <span className="text-xs font-medium text-gray-600 mt-2 group-hover:text-yellow-500 transition-colors duration-300">
                      JavaScript
                    </span>
                  </div>
                  ...
                  <div className="flex flex-col items-center group">
                    ...
                    <span className="text-xs font-medium text-gray-600 mt-2 group-hover:text-red-600 transition-colors duration-300">
                      Java
                    </span>
                  </div>
                  ...
                  <div className="flex flex-col items-center group">
                    ...
                    <span className="text-xs font-medium text-gray-600 mt-2 group-hover:text-blue-500 transition-colors duration-300">
                      Python
                    </span>
                  </div>
                  ...
                  <div className="flex flex-col items-center group">
                    ...
                    <span className="text-xs font-medium text-gray-600 mt-2 group-hover:text-orange-600 transition-colors duration-300">
                      HTML5
                    </span>
                  </div>
                  ...
                  <div className="flex flex-col items-center group">
                    ...
                    <span className="text-xs font-medium text-gray-600 mt-2 group-hover:text-blue-400 transition-colors duration-300">
                      CSS3
                    </span>
                  </div>
                  <div className="flex flex-col items-center group">
                  ...
                  <div className="flex flex-col items-center group">
                    ...
                    <span className="text-xs font-medium text-gray-600 mt-2 group-hover:text-red-500 transition-colors duration-300">
                      Git
                    </span>
                  </div>
                  ...
                  <div className="flex flex-col items-center group">
                    ...
                    <span className="text-xs font-medium text-gray-600 mt-2 group-hover:text-blue-700 transition-colors duration-300">
                      Database
                    </span>
                  </div>
                  ...
                  <div className="flex flex-col items-center group">
                    ...
                    <span className="text-xs font-medium text-gray-600 mt-2 group-hover:text-yellow-800 transition-colors duration-300">
                      Linux
                    </span>
                  </div>
                  ...
                  <div className="flex flex-col items-center group">
                    ...
                    <span className="text-xs font-medium text-gray-600 mt-2 group-hover:text-orange-500 transition-colors duration-300">
                      Blender
                    </span>
                  </div>
                  ...
                  <div className="flex flex-col items-center group">
                    ...
                    <span className="text-xs font-medium text-gray-600 mt-2 group-hover:text-gray-800 transition-colors duration-300">
                      Unity
                    </span>
                  </div>
                  ...
                  <div className="flex flex-col items-center group">
                    ...
                    <span className="text-xs font-medium text-gray-600 mt-2 group-hover:text-purple-600 transition-colors duration-300">
                      Unreal
                    </span>
                  </div>
                  <div className="flex flex-col items-center group">
